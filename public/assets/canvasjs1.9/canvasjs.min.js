...
(function() {
    ...
    function L(a, c, b) { return a in c ? c[a] : b[a] }
    ...
    function ua() { for (var a = null, c = 0; c < arguments.length; c++) a = arguments[c], a.style && (a.style.display = "inline") }
    ...
    function va(a, c) {
        for (var b = [], d, f = 0; f < a.length; f++)
            if (0 == f) b.push(a[0]);
                ...
                var l = (a[h].x - a[g].x) / d;
                d = (a[h].y - a[g].y) / d;
                b[b.length] = a[k].x > a[g].x && 0 < l || a[k].x < a[g].x && 0 > l ? { x: a[k].x + l / 3, y: a[k].y + d / 3 } : { x: a[k].x, y: a[k].y + d / 9 };
                k = f;
                g = 0 === k ? 0 : k - 1;
                h = k === a.length - 1 ? k : k + 1;
    ...
    function na(a, c) {
        ...
        if (x(this.options.margin) && a.options.subtitles)
            for (var b = a.options.subtitles, d = 0; d < b.length; d++)
                if ((x(b[d].horizontalAlign) && "center" === this.horizontalAlign || b[d].horizontalAlign === this.horizontalAlign) && (x(b[d].verticalAlign) && "top" === this.verticalAlign || b[d].verticalAlign === this.verticalAlign) && !b[d].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break }
    ...
    var z = {},
        ...
        ha = {
            ...
            theme3: {
                Chart: { colorSet: "colorSet1" },
                Title: { fontFamily: v ? "Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif" : "calibri", fontSize: 32, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 },
        ...
        ca = function(a, c, b) {
            ...
            for (var u = 0; k && u < k.length; u++)
                if (c = k[u], "." === c && 0 > l) l = u;
                    ...
                    if ("%" === c) h *= 100;
                    else if ("\u2030" === c) { h *= 1E3; continue } else if ("," === c[0] && "." === c[c.length - 1]) {
            ...
            else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (u++, k = q, q = 0, 0 < h.length && (b = g + b)) : b = 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? c.slice(1, c.length - 1) + b : c + b : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""), b += c.replace(/[0]+/, function(a) { return O(s, a.length) }));
            g = "";
    ...
    (function() {
        z.fSDec = function(a) { for (var c = "", b = 0; b < a.length; b++) c += String.fromCharCode(a[b] - 111); return c };
        z.str = {
    ...
    M.prototype.addEventListener = function(a, c, b) { a && c && (this._eventListeners[a] = this._eventListeners[a] || [], this._eventListeners[a].push({ context: b || this, eventHandler: c })) };
    ...
    A.prototype._updateOptions = function() {
        ...
        if (!this._dropdownMenu && this.exportEnabled && v) {
            ...
            K(c, "mouseover", function() { this.style.backgroundColor = "#EEEEEE" }, !0);
            K(c, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            K(c, "click", function() {
                a.print();
                Y(a._dropdownMenu)
            }, !0);
                    ...
                    if (!(d < u) || p) {
                        ...
                        if (b.viewPortMin === d && f)
                            for (y = 0; y < f.length; y++)
                                if (null === f[y] && r < d) { b.viewPortMin = r; break }
    ...
    A.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        for (b = 0; b < d.length; b++)
            if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)
                if (f = L("markerSize", d[b].dataPoint, d[b].dataSeries) || 8, d[b].distance <= f / 2) { c = !0; break }
    ...
    A.prototype.getAutoFontSize = function(a, c, b) { a /= 400; return Math.max(10, Math.round(Math.min(this.width, this.height) * a)) };
    ...
    A.prototype._plotAreaMouseMove = function(a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) ||
                ...
                if (this.panEnabled) f = { x1: f ? this.plotArea.x1 + b : this.plotArea.x1, y1: g ? this.plotArea.y1 + d : this.plotArea.y1, x2: f ? this.plotArea.x2 + b : this.plotArea.x2, y2: g ? this.plotArea.y2 + d : this.plotArea.y2 }, clearTimeout(h._panTimerId), h._panTimerId = setTimeout(function(b, d, e, f) {
                    return function() {
    ...
    A.prototype.validateRegion = function(a, c, b, d,
        ...
        for (g = 0; g < m.length; g++) {
            var h = m[g],
                p = h.convertPixelToValue({ x: a, y: c }),
                e = h.convertPixelToValue({ x: b, y: d });
            if (p >
                e) var r = e,
                e = p,
                p = r;
            if (isFinite(h.dataInfo.minDiff))
                if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) || p < h.minimum || e > h.maximum)) l.push(h), n.push({ val1: p, val2: e }), k = !0;
                else if (!f) { k = !1; break }
        }
    ...
    A.prototype.renderIndexLabels =
        function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) y = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: w.total, percent: w.percent };
                ...
                if (null !== t && "" !== t) {
                    ...
                    if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) { if (m.dataPoint.x < Z.viewportMinimum || m.dataPoint.x > Z.viewportMaximum || m.dataPoint.y < ja.viewportMinimum || m.dataPoint.y > ja.viewportMaximum) continue } else if (0 <= n.indexOf("column")) {
                        if (m.dataPoint.x < Z.viewportMinimum ||
                            m.dataPoint.x > Z.viewportMaximum || m.bounds.y1 > b.y2 || m.bounds.y2 < b.y1) continue
                    } else if (0 <= n.indexOf("bar")) { if (m.dataPoint.x < Z.viewportMinimum || m.dataPoint.x > Z.viewportMaximum || m.bounds.x1 > b.x2 || m.bounds.x2 < b.x1) continue } else if (m.dataPoint.x < Z.viewportMinimum || m.dataPoint.x > Z.viewportMaximum) continue;
                    f = h = 2;
                        ...
                        if (u = l[s].x.getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                            if ("number" !== typeof l[s].y) 0 < s && !(k.connectNullData || y || q) && (c.stroke(), v && b.stroke()), y = !0;
                                ...
                                if (0 < l[s].markerSize || 0 < k.markerSize) {
                                    ...
                                    d.push(D);
                                    t = G(t);
                                    v && d.push({ x: u, y: w, ctx: b, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness })
                        ...
                        if (u = l[s].getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                            if ("number" !== typeof l[s].y) 0 < s && !(k.connectNullData || y || q) && (c.stroke(), v && b.stroke()), y = !0;
                                ...
                                if (0 < l[s].markerSize || 0 < k.markerSize) t = k.getMarkerProperties(s, u, w,
                                    c), f = t.color, d.push(t), D = G(D), v && d.push({ x: u, y: w, ctx: b, type: t.type, size: t.size, color: D, borderColor: D, borderThickness: t.borderThickness });
                                (l[s].indexLabel || k.indexLabel || l[s].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepLine", dataPoint: l[s], dataSeries: k, point: { x: u, y: w }, direction: 0 > l[s].y === a.axisY.reversed ? 1 : -1, color: e })
                            }
                    c.stroke();
                    v && b.stroke()
                }
                        ...
                        if (u = m[s].getTime ? m[s].x.getTime() : m[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !w)))
                            if ("number" !== typeof m[s].y) 0 < s && !w && (l.connectNullData ? b.setLineDash && (0 < y.length && (l.options.nullDataLineDashType || !m[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, n = l.nullDataLineDashType) :
                                ...
                                if (0 < m[s].markerSize || 0 < l.markerSize) {
                                    ...
                                    f.push(D);
                                    t = G(t);
                                    v && f.push({ x: u, y: w, ctx: d, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness })
                                }(m[s].indexLabel || l.indexLabel || m[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: m[s], dataSeries: l, point: { x: u, y: w }, direction: 0 > m[s].y === a.axisY.reversed ? 1 : -1, color: r });
                                w = !1
                            }
                c(y)
            }
                ...
                if (0 < e.length)
                    for (var r =
                        ...
                        if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: f, x1: g, y1: h, x2: q, y2: s };
                            b = G(b);
                    ...
                    if (0 < q.length)
                        for (var s = 5 < p && r.bevelEnabled ? !0 : !1, k = 0; k < q.length; k++)
                            if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                                ...
                                b = G(b);
                                v && N(this._eventManager.ghostCtx, u, l, w, y, b, 0, null, !1, !1, !1, !1);
                                (q[k].indexLabel || r.indexLabel || q[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: q[k], dataSeries: r, point: { x: d, y: 0 <= q[k].y ? l : y }, direction: 0 > q[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: u, y1: Math.min(l, y), x2: w, y2: Math.max(l, y) }, color: b })
                            }
                }
                c.restore();
                v && this._eventManager.ghostCtx.restore();
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: f, x1: s, y1: h, x2: g, y2: q };
                            b = G(b);
                ...
                if (0 < q.length) {
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                            ...
                            (q[k].indexLabel || r.indexLabel || q[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: q[k], dataSeries: r, point: { x: 0 <= q[k].y ? l : u, y: d }, direction: 0 > q[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(u, l), y1: w, x2: Math.max(u, l), y2: y }, color: b })
                        }
                }
            }
            c.restore();
                        ...
                        if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !J)))
                            if ("number" !== typeof p[r].y) n.connectNullData || (J || e) || c(), J = !0;
                                ...
                                e || J ? (!e && n.connectNullData ? (b.setLineDash && (n.options.nullDataLineDashType || A === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (b.stroke(), A = n.nullDataLineDashType,
                                    b.setLineDash(B)), b.lineTo(q, s), v && d.lineTo(q, s)) : (b.beginPath(), b.moveTo(q, s), v && (d.beginPath(), d.moveTo(q, s)), t = { x: q, y: s }), J = e = !1) : (b.lineTo(q, s), v && d.lineTo(q, s), 0 == r % 250 && c());
                                ...
                                0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < n.markerSize) && (u = n.getMarkerProperties(r, q, s, b), k = u.color, h.push(u), H = G(H), v && h.push({ x: q, y: s, ctx: d, type: u.type, size: u.size, color: H, borderColor: H, borderThickness: u.borderThickness }));
                        ...
                        if (r = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax &&
                            ...
                            if ("number" !== typeof p[e].y) 0 < e && !q && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, z = n.nullDataLineDashType) : (c(), y = [])), q = !0;
                                ...
                                if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < n.markerSize)) {
                                    ...
                                    h.push(J);
                                    R = G(R);
                                    v && h.push({ x: r, y: q, ctx: d, type: J.type, size: J.size, color: R, borderColor: R, borderThickness: J.borderThickness })
                                }(p[e].indexLabel ||
                                    n.indexLabel || p[e].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: p[e], dataSeries: n, point: { x: r, y: q }, direction: 0 > p[e].y === a.axisY.reversed ? 1 : -1, color: t });
                                q = !1
                            }
                    c();
                    P.drawMarkers(h);
                ...
                if (0 < m.length) {
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        ...
                        var H = null,
                            ...
                            D[t.dataPointIndexes[q]] : { x: q, y: null };
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || c(), J = !0;
                                ...
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType ||
                                    A === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), A = t.nullDataLineDashType, b.setLineDash(B)), b.lineTo(e, r), v && u.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), v && (u.beginPath(), u.moveTo(e, r))), J = w = !1) : (b.lineTo(e, r), v && u.lineTo(e, r), 0 == p % 250 && (c(), b.moveTo(e, r), v && u.moveTo(e, r), l.push({ x: e, y: s - da })));
                                p < D.length - 1 && (z !== (D[p].lineColor || x) || A !== (D[p].lineDashType || t.lineDashType)) && (c(), b.beginPath(), b.moveTo(e, r), l.push({ x: e, y: s - da }), z = D[p].lineColor || x, b.strokeStyle = z, b.setLineDash &&
    ...
    A.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                w = !0;
                d = t.id;
                this._eventManager.objectMap[d] = { objectType: "dataSeries", dataSeriesIndex: y };
                d = G(d);
                u.fillStyle = d;
                l = [];
                if (0 < m.length) {
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        ...
                        var H = null,
                            H = 0 <= t.dataPointIndexes[q] ?
                            x[t.dataPointIndexes[q]] : { x: q, y: null };
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || c(), J = !0;
                            else {
                                var da;
                                ...
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(p, e, r, b),
                                    h = q.color, g.push(q), markerColor = G(Ga), v && g.push({ x: e, y: r, ctx: u, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness }));
                                (H.indexLabel || t.indexLabel || H.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: H, dataSeries: t, point: { x: e, y: r }, direction: 0 > x[p].y === a.axisY.reversed ? 1 : -1, color: d })
                            }
                    }
                    c();
                    b.moveTo(e, r);
                ...
                if (m = a.dataSeriesIndexes[l], n = this.data[m], p = n.dataPoints,
                    ...
                    for (c.strokeStyle = "#4572A7 ", d = 0; d < p.length; d++)
                        if (f = p[d].getTime ? f = p[d].x.getTime() : f = p[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[d].y) {
                            ...
                            this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: d, x1: f, y1: g, size: q };
                            q = G(s);
                            v && P.drawMarker(f, g, this._eventManager.ghostCtx, e.type, e.size, q, q, e.borderThickness);
                            (p[d].indexLabel || n.indexLabel || p[d].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: p[d], dataSeries: n, point: { x: f, y: g }, direction: 1, bounds: { x1: f - e.size / 2, y1: g - e.size / 2, x2: f + e.size / 2, y2: g + e.size / 2 }, color: null })
                        }
            c.restore();
            v && this._eventManager.ghostCtx.restore();
                ...
                if (0 < m.length) {
                    ...
                    for (var n = 0, p = 0, d = 0; d < m.length; d++)
                        if (f = m[d].getTime ? f = m[d].x.getTime() : f = m[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[d].y) {
                            ...
                            c.globalAlpha = 1;
                            Math.sqrt((n - f) * (n - f) + (p - g) * (p - g)) < Math.min(e.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = l.dataPointIds[d], this._eventManager.objectMap[n] = { id: n, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: d, x1: f, y1: g }, n = G(n), v && P.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, n, n, e.borderThickness), (m[d].indexLabel || l.indexLabel ||
                    ...
                    for (var u = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? n = s[f].x.getTime() : n = s[f].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                            ...
                            var w = g - p / 2 << 0,
                                ...
                                x = 0 === t % 2 ? 0 : 0.5,
                                z = q.dataPointIds[f];
                            this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: f, x1: w, y1: h, x2: y, y2: k, x3: g, y3: l, x4: g, y4: m, borderThickness: t, color: d };
                            c.strokeStyle = d;
                            c.beginPath();
                            c.lineWidth = t;
                            ...
                            (s[f].indexLabel || q.indexLabel || s[f].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: q.type, dataPoint: s[f], dataSeries: q, point: { x: w + (y - w) / 2, y: a.axisY.reversed ? l : k }, direction: 1, bounds: { x1: w, y1: Math.min(k, l), x2: y, y2: Math.max(k, l) }, color: d })
                        }
            }
            c.restore();
            v && b.restore();
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== e[f].y && e[f].y.length && "number" === typeof e[f].y[0] && "number" === typeof e[f].y[1]) {
                            ...
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f, x1: d, y1: h, x2: g, y2: q };
                            b = G(b);
                            v && N(this._eventManager.ghostCtx, d, h, g, q,
                                b, 0, null, !1, !1, !1, !1);
                            if (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: e[f], dataSeries: p, indexKeyword: 0, point: { x: e[f].y[1] >= e[f].y[0] ? d : g, y: h + (q - h) / 2 }, direction: e[f].y[1] >= e[f].y[0] ? -1 : 1, bounds: { x1: Math.min(d, g), y1: h, x2: Math.max(d, g), y2: q }, color: b }), this._indexLabels.push({
                                chartType: "rangeBar",
                                dataPoint: e[f],
                                dataSeries: p,
                                indexKeyword: 1,
                                point: { x: e[f].y[1] >= e[f].y[0] ? g : d, y: h + (q - h) / 2 },
                                direction: e[f].y[1] >= e[f].y[0] ?
                                    1 : -1,
                                bounds: { x1: Math.min(d, g), y1: h, x2: Math.max(d, g), y2: q },
                                color: b
                            })
                        }
                }
                        ...
                        if (u = n[e].x.getTime ? n[e].x.getTime() : n[e].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !E)))
                            if (null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" === typeof n[e].y[1]) {
                                ...
                                p || E ? (m.connectNullData && !p ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (k[k.length -
                                    1].newLineDashArray = B, z = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(r, q), v && d.lineTo(r, q), k.push({ x: r, y: s })) : (b.beginPath(), b.moveTo(r, q), w = { x: r, y: q }, k = [], k.push({ x: r, y: s }), v && (d.beginPath(), d.moveTo(r, q))), E = p = !1) : (b.lineTo(r, q), k.push({ x: r, y: s }), v && d.lineTo(r, q), 0 == e % 250 && c());
                                u = m.dataPointIds[e];
                                ...
                                if (0 !== n[e].markerSize && (0 < n[e].markerSize || 0 < m.markerSize)) {
                                    ...
                                    f.push(R);
                                    var J = G(u);
                                    v && f.push({ x: r, y: s, ctx: d, type: R.type, size: R.size, color: J, borderColor: J, borderThickness: R.borderThickness });
                                    R = m.getMarkerProperties(e, r, q, b);
                                    g = R.color;
                                    f.push(R);
                                    J = G(u);
                                    v && f.push({ x: r, y: q, ctx: d, type: R.type, size: R.size, color: J, borderColor: J, borderThickness: R.borderThickness })
                                }
                        ...
                        if (p = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !e)))
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                if (0 !== m[n].markerSize && (0 < m[n].markerSize || 0 < l.markerSize)) {
                                    ...
                                    f.push(B);
                                    var E = G(A);
                                    v && f.push({ x: p, y: e, ctx: d, type: B.type, size: B.size, color: E, borderColor: E, borderThickness: B.borderThickness });
                                    B = l.getMarkerProperties(n, p, r, b);
                                    f.push(B);
                                    E = G(A);
                                    v && f.push({ x: p, y: r, ctx: d, type: B.type, size: B.size, color: E, borderColor: E, borderThickness: B.borderThickness })
                                }
                                if (m[n].indexLabel || l.indexLabel || m[n].indexLabelFormatter || l.indexLabelFormatter) this._indexLabels.push({
                                    ...
                                    color: u
                                }), this._indexLabels.push({ chartType: "splineArea", dataPoint: m[n], dataSeries: l, indexKeyword: 1, point: { x: p, y: r }, direction: m[n].y[0] <= m[n].y[1] ? 1 : -1, color: u });
                                e = !1
    ...
    A.prototype.renderPie = function(a) {
            ...
            for (b = 0; b < n.length; b++) {
                ...
                if (d > c) {
                    var f = 0.07 * B * Math.cos(r[b].midAngle),
                        ...
                        k = !1;
                    if (n[b].exploded) { if (1E-9 < Math.abs(r[b].center.x - (t.x + f)) || 1E-9 < Math.abs(r[b].center.y - (t.y + g))) r[b].center.x = t.x + f * a, r[b].center.y = t.y + g * a, k = !0 } else if (0 < Math.abs(r[b].center.x - t.x) || 0 < Math.abs(r[b].center.y - t.y)) r[b].center.x = t.x + f * (1 - a), r[b].center.y = t.y + g * (1 - a), k = !0;
        ...
        function f(a) {
            for (var b = null, c = 1; c < n.length; c++)
                if (b = (a + c + r.length) % r.length, r[b].hemisphere !== r[a].hemisphere) { b = null; break } else if (r[b].indexLabelText && b !== a && (0 > d(r[b], r[a]) || ("right" === r[a].hemisphere ? r[b].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y : r[b].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y))) break;
            else b = null;
            return b
        }
        ...
        function g(a, b, c) {
            ...
            if (0 <= a && a < n.length) {
                ...
                for (l = 1; l < n.length; l++)
                    if (k = (a - l + r.length) % r.length, r[k].hemisphere !== r[a].hemisphere) { k = null; break } else if (r[k].indexLabelText && r[k].hemisphere === r[a].hemisphere && k !== a && (0 > d(r[k], r[a]) ||
    ...
    A.prototype.requestAnimFrame = function() { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(a) { window.setTimeout(a, 1E3 / 60) } }();
    ...
    ia.prototype.registerSpace = function(a, c) { "top" === a ? this._topOccupied += c.height : "bottom" === a ? this._bottomOccupied += c.height : "left" === a ? this._leftOccupied += c.width : "right" === a && (this._rightOccupied += c.width) };
    ...
    ia.prototype.getFreeSpace = function() { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } };
        ...
        for (var n = 0; n < this.dataSeries.length; n++) {
            ...
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                var e = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? $.getDefaultLegendMarker(p.type) :
                    ...
                    e = { markerType: e, markerColor: q, text: r, textBlock: null, chartType: p.type, markerSize: s, lineColor: p._colorSet[0], dataSeriesIndex: p.index, dataPointIndex: null, markerBorderColor: u, markerBorderThickness: w };
                l.push(e)
            } else
                for (var v = 0; v < p.dataPoints.length; v++) {
                    var t = p.dataPoints[v],
                        ...
                        p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: t }) : t.name ? t.name : "DataPoint: " + (v + 1),
            ...
            for (n = 0; n < l.length; n++) {
                ...
                if (!(0 >= h || "undefined" === typeof h || 0 >= r || "undefined" === typeof r)) {
                    if ("horizontal" === this.orientation) {
                        e.textBlock =
                            new W(this.ctx, { x: 0, y: 0, maxWidth: r, maxHeight: this.itemWrap ? h : this.lineHeight, angle: 0, text: e.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" });
                        ...
                        if (!p || p.width + Math.round(e.textBlock.width +
                                s + k + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) p = { items: [], width: 0 }, m.push(p), this.height += v, v = 0;
                        ...
                        e.textBlock.measureText(), null !== this.itemWidth && (e.textBlock.width = this.itemWidth - (s + k + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < h - this.lineHeight ? (p = { items: [], width: 0 }, m.push(p)) : (p = m[t], t = (t + 1) % m.length), this.height += e.textBlock.height;
    ...
    $.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        var d = [],
            ...
            n = 0,
            p = 0;
        "none" !== this.chart.plotInfo.axisPlacement && (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: c }), this.axisX.logarithmic ? (g = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), p = 1 < g ? Math.min(Math.max((this.dataPoints.length - 1) / g * Math.log(p / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (g = this.dataPoints[this.dataPoints.length -
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "scatter":
                            ...
                            q <= u && d.push({ dataPoint: r, dataPointIndex: g, dataSeries: this, distance: q });
                            g = Math.abs(e.x1 - a);
                            g <= l ? l = g : 0 < h ? m++ : n++;
                            q <= s / 2 && (k = !0);
                            break;
                        ...
                        case "bubble":
                            s = e.size;
                            q = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - c, 2));
                            q <= s / 2 && (d.push({ dataPoint: r, dataPointIndex: g, dataSeries: this, distance: q }), k = !0);
                            break;
                        case "pie":
                        case "doughnut":
                            s =
            ...
            if (this.labelAutoFit ||
                ...
                if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                    if (g = 0.9 * l >> 0, p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock; for (var q, s = a.text.split(" "), d = 0; d < s.length; d++) e = s[d], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, e = this.ctx.measureText(e), e.width > p && (q = b, p = e.width) }
                        b = 0;
            ...
            for (; 4 > r;) {
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) a[e] && (a[e].lineCoordinates.x1 = h, a[e].lineCoordinates.x2 = Math.round(g.x2 - T - S > n.width - 10 ? n.width - 10 : g.x2 - T - S), a[e]._labels && 1 < a[e]._labels.length && (k = m = 0, m = a[e]._labels[1], k = "dateTime" === a[e].chart.plotInfo.axisXValueType ? a[e]._labels[a[e]._labels.length - 2] : a[e]._labels[a[e]._labels.length - 1], q = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) +
                        ...
                        f + N), m = Math.round(g.y2), a[e].lineCoordinates.x2 = l, a[e].lineCoordinates.width = l - h, a[e].lineCoordinates.y1 = k, a[e].lineCoordinates.y2 = k, a[e].bounds = { x1: h, y1: k, x2: l, y2: m - (X + f - u[e] - N), width: l - h, height: m - k }), N += u[e] + a[e].margin;
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e].lineCoordinates.x1 = Math.round(g.x1 + U + C), c[e].lineCoordinates.x2 = Math.round(g.x2 - T - S > n.width - 10 ? n.width - 10 : g.x2 - T - S), c[e].lineCoordinates.width = Math.abs(l - h), c[e]._labels && 1 < c[e]._labels.length && (m = c[e]._labels[1], k = "dateTime" === c[e].chart.plotInfo.axisXValueType ?
                        ...
                        m = Math.round(g.y2 + c[e].margin), c[e].lineCoordinates.y1 = k + V + L - Q, c[e].lineCoordinates.y2 = k, c[e].bounds = { x1: h, y1: k + (V + L - w[e] - Q), x2: l, y2: m, width: l - h, height: m - k }, Q += w[e] + c[e].margin;
                if (b && 0 < b.length)
            ...
            for (; 4 > r;) {
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        a[e].bounds = { x1: l - (B[e] + K), y1: k, x2: l, y2: m, width: l - h, height: m - k };
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) {
                        ...
                        c[e].lineCoordinates = { x1: l + P, y1: k, x2: l + P, y2: m, height: Math.abs(m - k) };
                        c[e].bounds = { x1: h, y1: k, x2: l, y2: m, width: l - h, height: m - k };
    ...
    B.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            if (!h) {
                ...
                for (d = 0; d < l.length; d++) b = l[d], b.stripLine.showOnTop ? h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { for (f = 0; f < l.length; f++) b = l[f], "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (c.ctx.save(), c.ctx.beginPath(), c.ctx.rect(c.chart.plotArea.x1, c.chart.plotArea.y1, c.chart.plotArea.width, c.chart.plotArea.height), c.ctx.clip(), b.textBlock.render(!0), c.ctx.restore()) }, b.textBlock)) :
                    "inside" === b.stripLine.labelPlacement && b.textBlock.render(!0);
                this.ctx.restore();
                h = !0
            }
            if (h)
                for (h = !1, d = 0; d < l.length; d++) b = l[d], b.stripLine.showOnTop ? h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { for (f = 0; f < l.length; f++) b = l[f], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0) }, b.textBlock)) : "outside" === b.stripLine.labelPlacement && b.textBlock.render(!0)
        }
    };
    ...
    oa.prototype.render = function() {
        ...
        if (0 < c) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) f = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = { x1: f - c / 2, y1: h, x2: g + c / 2, y2: k };
            else if ("left" === this.parent._position || "right" === this.parent._position) h = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, f = this.chart.plotArea.x1, g = this.chart.plotArea.x2, this.bounds = { x1: f, y1: h - c / 2, x2: g, y2: k + c / 2 };
            this.ctx.moveTo(f, h);
            this.ctx.lineTo(g,
                k);
            this.ctx.stroke();
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var k = 0; k < this.chart.axisX.length; k++) {
                            for (var h = this.chart.axisX[k].convertPixelToValue({ y: c }), l = null, d = 0; d < this.chart.axisX[k].dataSeries.length; d++)(l = this.chart.axisX[k].dataSeries[d].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[k].dataSeries[d], null !== l.dataPoint.y && f.push(l));
                            l = null
                        }
                    ...
                    if (this.chart.axisX)
                        for (k = 0; k < this.chart.axisX.length; k++)
                            for (h = this.chart.axisX[k].convertPixelToValue({ x: a }), l = null, d = 0; d < this.chart.axisX[k].dataSeries.length; d++)(l = this.chart.axisX[k].dataSeries[d].getDataPointAtX(h,
                                b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[k].dataSeries[d], null !== l.dataPoint.y && f.push(l));
                    if (this.chart.axisX2)
                        for (k = 0; k < this.chart.axisX2.length; k++)
                            for (h = this.chart.axisX2[k].convertPixelToValue({ x: a }), l = null, d = 0; d < this.chart.axisX2[k].dataSeries.length; d++)(l = this.chart.axisX2[k].dataSeries[d].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[k].dataSeries[d], null !== l.dataPoint.y && f.push(l))
                }
    ...
    S.prototype.getToolTipInnerHTML = function(a) {
        ...
        for (var c = null, b = null, d = null, f = 0, g = "", h = !0, k = 0; k < a.length; k++)
            if (a[k].dataSeries.toolTipContent || a[k].dataPoint.toolTipContent) { h = !1; break }
        if (h && (this.content && "function" === typeof this.content || this.contentFormatter)) a = { chart: this.chart, toolTip: this.options, entries: a }, c = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
    ...
    S.prototype.hide = function(a) { this.container && (this.container.style.display = "none", this.currentSeriesIndex = -1, this._prevY = this._prevX = NaN, ("undefined" === typeof a || a) && this.chart.resetOverlayedCanvas()) };
    S.prototype.show = function(a, c, b) { this._updateToolTip(a, c, "undefined" === typeof b ? !1 : b) };
            ...
            if ((d = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[d])
                if (d = this.objectMap[d], "dataPoint" === d.objectType) {
                    var f = this.chart.data[d.dataSeriesIndex],
                        ...
                        h = d.dataPointIndex;
                    d.eventParameter = { x: b.x, y: b.y, dataPoint: g, dataSeries: f.options, dataPointIndex: h, dataSeriesIndex: f.index, chart: this.chart };
    ...
    var F = {
        ...
        ka = {
            ...
            addCultureInfo: function(a, c) { qa[a] = c },
